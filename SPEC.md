...
| **Settings** | Length（先頭。ながさチェンジ。auto/5〜30分・5分刻み。F-28, Issue #19）・デフォルト曲長（分単位・1分刻み。Issue #16）・Skip short（短い曲のスキップ。off/0〜30秒・1秒刻み。F-29, Issue #21）・リピート・シャッフル（F-25, P10）・ステレオ深度・EQ・Fade・Show all files・Scroll title（Issue #8）・Show battery（F-26, Issue #7）。`X`で全項目を既定値に戻す確認ダイアログを開ける（P10） |
